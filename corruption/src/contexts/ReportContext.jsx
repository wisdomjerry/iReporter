...
  const { currentUser, setCurrentUser, markFirstLoginSeen } = useUsers(); // IMPORT markFirstLoginSeen
...
      // Update firstLoginShown if backend provides it (This is good to keep)
...
      // MARK FIRST LOGIN (We keep this logic here as a safeguard)
      if (!currentUser.firstLoginShown) {
        // ⭐ UPDATED: Use the imported function from UserContext
        await markFirstLoginSeen(); 
        // The markFirstLoginSeen function in UserContext already handles 
        // setCurrentUser and calling the API service.
      }
